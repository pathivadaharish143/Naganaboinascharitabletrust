...
(function(factory) {
    ...
    (function() {
        ...
        $.fn.position = function(options) {
            ...
            var atOffset, targetWidth, targetHeight, targetOffset, basePosition, dimensions, target = typeof options.of === "string" ? $(document).find(options.of) : $(options.of),
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        _destroy: function() {
            ...
            this.element.removeAttr("aria-activedescendant").find(".ui-menu").addBack().removeAttr("role aria-labelledby aria-expanded aria-hidden aria-disabled " +
                "tabIndex").removeUniqueId().show();
        ...
        _generateHTML: function(inst) {
            ...
            if (this._canAdjustMonth(inst, -1, drawYear, drawMonth)) {
                prev = $("<a>").attr({
                    ...
                    "data-event": "click",
                    title: prevText
                }).append($("<span>").addClass("ui-icon ui-icon-circle-triangle-" +
            ...
            if (this._canAdjustMonth(inst, +1, drawYear, drawMonth)) {
                ...
                next = $("<a>").attr({
                    ...
                    title: nextText
                }).append($("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" +
                    (isRTL ? "w" : "e")).text(nextText))[0].outerHTML;
            }
